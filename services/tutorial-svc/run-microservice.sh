...
export OTEL_RESOURCE_ATTRIBUTES=service.name=tutorial-svc,service.version=0.0.1-SNAPSHOT,deployment.environment="dev"
...
java -javaagent:./otel-dist/opentelemetry-javaagent.jar -jar target/tutorial-svc-0.0.1-SNAPSHOT.jar